...
RawResultFolder = [RootFolder filesep 'A0_all_results_eval_TransE_21to30'];
...
for subj=1:nSub
    ...
    nfile=length(rfile);
    targetFolder = [RootFolder filesep 'A1_fishZ_all_eval_TransE_21to30' filesep  SubFolder(subj).name];
    mkdir(targetFolder);
    for i=1:nfile
