...
RawResultFolder = [RootFolder filesep 'A0_all_results_eval_TransE_31to40'];
...
for subj=1:nSub
    ...
    nfile=length(rfile);
    targetFolder = [RootFolder filesep 'A1_fishZ_all_eval_TransE_31to40' filesep  SubFolder(subj).name];
    mkdir(targetFolder);
    for i=1:nfile
